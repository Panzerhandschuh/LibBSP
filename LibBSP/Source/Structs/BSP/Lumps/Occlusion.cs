...
namespace LibBSP {
	...
	/// <summary>
	/// Holds the occlusion data for a BSP.
	/// </summary>
	public class Occlusion : ILump {
		...
		/// <summary>
		/// Array of <c>byte</c>s used as the data source for occlusion info.
		/// </summary>
		...
		/// <summary>
		/// Parses the passed <c>byte</c> array into a <see cref="Occlusion"/> object.
		/// </summary>
		/// <param name="data">Array of <c>byte</c>s to parse.</param>
		/// <param name="bsp">The <see cref="BSP"/> this lump came from.</param>
		/// <param name="lumpInfo">The <see cref="LumpInfo"/> associated with this lump.</param>
		/// <exception cref="ArgumentNullException"><paramref name="data"/> was <c>null</c>.</exception>
		public Occlusion(byte[] data, BSP bsp, LumpInfo lumpInfo = default(LumpInfo)) {
			if (data == null) {
